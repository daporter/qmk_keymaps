...
[NUM] = LAYOUT(
    ...
    KC_0,    KC_4, KC_5, KC_6, KC_EQL,         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
 ...
 *                                                                                   generated by [keymapviz] */
[ADJ] = LAYOUT(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BRIU,         XXXXXXX, XXXXXXX, KC_VOLU, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BRID,         XXXXXXX, XXXXXXX, KC_VOLD, XXXXXXX, XXXXXXX,
		     ...
		     uint16_t other_keycode, keyrecord_t *other_record)
{
	...
	case L_SYM:
		// All SYM layer-switch key chords should be conisdered holds
		return true;
	}
