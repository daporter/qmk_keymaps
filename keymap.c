...
[BASE] = LAYOUT(
    KC_J,   KC_G,   KC_M,   KC_P,   KC_V,         KC_Z,    KC_COMM, KC_DOT, KC_QUES, KC_QUOT,
    HOME_R, HOME_S, HOME_N, HOME_D, KC_B,         KC_SLSH, HOME_A, HOME_E,  HOME_I,  HOME_H,
 ...
 *                                                                                   generated by [keymapviz] */
[SYM] = LAYOUT(
    KC_GRV,  KC_LT,   KC_GT,   KC_AT,   KC_CIRC,       XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, XXXXXXX,
    KC_EXLM, KC_MINS, KC_PLUS, KC_EQL,  KC_COLN,       XXXXXXX, KC_UNDS, KC_LPRN, KC_RPRN, KC_PERC,
    KC_APP,  KC_DLR,  KC_ASTR, KC_BSLS, KC_TILD,       XXXXXXX, KC_HASH, KC_LCBR, KC_RCBR, XXXXXXX,
...
combo_t key_combos[] = {
	...
	COMBO(combo_u_y,        QU),
	COMBO(combo_y_k,        KC_Q),

	COMBO(combo_t_sym,      TG(ADJ)),
};
